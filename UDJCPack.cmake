...
set( CPACK_PACKAGE_CONTACT  "Kurtis Nusbaum <klnusbaum@bazaarsolutions.com>" )

set( APPLICATION_NAME "UDJ")
...
if(APPLE)
    ...
    set( CPACK_PACKAGE_FILE_NAME UDJSetup-${CPACK_PACKAGE_VERSION} )
    set( CPACK_PACKAGE_ICON ${CMAKE_BINARY_DIR}/icons/udjlauncher.icns)
...
if(WIN32)
    set( CPACK_PACKAGE_FILE_NAME  UDJ-${CPACK_PACKAGE_VERSION}-setup )
    ...
    set( CPACK_PACKAGE_DESCRIPTION_SUMMARY  "UDJ Desktop Player Client" ) #  Description summary of a project
    ...
    set( CPACK_PACKAGE_INSTALL_DIRECTORY  ${APPLICATION_NAME} )     # Installation directory on the target system -> C:\Program Files\UDJ
    ...
    set( CPACK_PACKAGE_VENDOR  "http://udjplayer.com" )   # Package vendor name
endif()
